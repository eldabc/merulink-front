...
export const statusConfig = {
    [STATUSES.AVAILABLE]: { label: 'Disponible', title: { padlock: 'Candado Disponible', locker: 'Locker Disponible' }, classes: 'bg-green-100 text-green-800 hover:border-green-800' },
    ...
    [STATUSES.ASSIGNED]: { label: 'Asignado', title: 'Candado Asignado', classes: 'bg-red-100 text-red-800 hover:border-red-800' },
