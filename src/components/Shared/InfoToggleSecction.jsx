...
function InfoToggleSeccion({ createdBy, showTemplateToggle, readOnly, register, errors, setValue, templateInfo, isRegisteredTemplate }) {
    ...
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 mt-3">
      ...
      {showTemplateToggle && (
        ...
        {templateInfo?.hasTemplate ? (   
          ...
          !isRegisteredTemplate && <ToggleCreateTemplate readOnly={readOnly} register={register} errors={errors} setValue={setValue} />
        )}
