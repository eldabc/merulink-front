...
export default function FilterByFields({ searchValue, searchDateValue, onSearchChange, filterStatus, onFilterStatus, onFilterDate, showFilterStatus = false, showFilterDate = false, moduleName = '', placeholder = '' }) {
  return (
